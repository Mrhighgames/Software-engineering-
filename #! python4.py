...
def puzzle(rotation, selection):
    ...
    if word == string:
        print('The walls start crumbling, a door opens, you escape: Win')
    print(string)
    return
...
class TextAdventureCmd(cmd.Cmd):
    ...
    # create more dialogue + make global counter-prf
    def dialogue_w_prf(self):
        ...
        while True:
            ...
            if user_input == '1' or user_input.startswith('uhh'):
                ...
                while True:
                    if user_input == '1' or user_input.startswith('How'):
                        ...
                        break
                    if user_input == '2' or user_input.startswith('Okay'):
