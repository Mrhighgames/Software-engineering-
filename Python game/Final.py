        ...
        while True:
            ...
            if rep_doctor == 0:
                ...
                if user_input == '1' or user_input.startswith('Who'):  # Main response 1
                    ...
                    print("a: A fool, cant believe I am stuck here")
                    print("b: Doesnt matter, I am trapped here same as you")
                    print("c: exit")

                    user_input = input("> ").strip().lower()
                    if user_input == 'a' or user_input.startswith('A'):  # Side response 1-1
                        like_counter = +1
                        print('ok response [Reputation: ' + str(like_counter) + ']')
                        print("Doc Peter: Yes I know that, whatever, I have been stuck here with one bumbling idiot already, dont make it two")
                        ...
                        if user_input == '1' or user_input.startswith('Okay'):
                            print('ok response [Reputation: ' + str(like_counter) + ']')
                            print("Doc Peter: Yeah sure kid, by the way you smell like acid, the word starts with B as in boy get out my WAY")
                            self.cmdloop()
                            break
                        ...
                        elif user_input == '3' or user_input.startswith('exit'):
                            self.cmdloop()
                            break
                        else:
                            print('Not a valid response\n')
                        break
                    elif user_input == 'b':  # Side Response 1-2
                        like_counter = +1
                        rep_doctor = rep_doctor + like_counter
                        print('bad response [Reputation: ' + str(like_counter) + ']')
                        print("Doc Peter: Okay fine, it is nice to see a new face but ...")

                        print("Do dont you think I know that?, but yeah.. I guess I will help, I have some outdated textbooks here")
                        ...
                        if user_input == '1' or user_input.startswith('What'):
                            ...
                            print("Doctor Peter: They explain how the dials work, you twist them from right to left to find the correct combination")
                    ...
                    print(" Doc Peter: Yeah I guess so, my textbooks have told me how the puzzle works, I just cant get the right COMBINATION!")
                    ...
                    if user_input == '1' or user_input.startswith('Would'):  # Side Response 2-1
                        ...
                        print("Doc Peter: Took the words out of my mouth, before you go, move the dials right and left for the right word combo")
                        ...
                        print("1:wow tought crowd *awkward laugh*")
                    ...
                    if user_input == '1' or user_input.startswith('How'):  # Side Response 3-1
                        ...
                        if user_input == '1':
                            ...
                            rep_doctor = rep_doctor + like_counter
                            print('bad response [Reputation: ' + str(like_counter) + ']')
                            print("Doc Peter: Half of it, because I will give you the key and tablet now")
                            inventory.append('tablet')
                        ...
                        like_counter =  0
                        rep_doctor = rep_doctor + like_counter
                        print('okay response [Reputation: ' + str(like_counter) + ']')
                        ...
                        if user_input == '1' or user_input.startswith('wait'):
                            rep_doctor = like_counter -1
                            print('ok response [Reputation: ' + str(like_counter) + ']')
                            print("Doc Peter: Yeah, you will either have to kill me or get the treasure, and I was a boxer")
                            self.cmdloop()
                            break
                            ...
                            rep_doctor = rep_doctor + like_counter
                            print('good response [Reputation: ' + str(like_counter) + ']')
                            print("Doc Peter: Couldnt have said it better myself, now get along")
                            self.cmdloop()
                        ...
                        print('Not a valid response\n')
                elif user_input == '4' or user_input.startswith('exit'):  # Main response 4
                    break
                else:
                    print('Not a valid response\n')
            ...
            if rep_professor == 0:
                ...
                if user_input == '1' or user_input.startswith('uhh'):  # Main response 1
                    ...
                    if user_input == '1' or user_input.startswith('How'):  # Side response 1-1
                        ...
                        print("Prof Dan: WELL, I have been stuck here for what feels like centuries, I am more than qualified to explain")
                        ...
                        if user_input == '1':
                            print("Prof Dan:The ancient Pharoh that once built this place wanted to prevent grave robbers.. guess it worked")
                            print("Prof Dan: The only way to truly escape is to solve his riddle, maybe you can give me some insight?")
                            like_counter = rep_professor + 2
                            print('good response [Reputation: ' + str(like_counter) + ']')
                            print("a:What do you know about it?")
                            print("b:Yeah I have no clue, I just need to get out of here")
                            print("c:Exit")
                            user_input = input("> ").strip().lower()
                            if user_input == 'a' and user_input.startswith('What') and rep_professor < 1:
                                print("Prof Dan: Only one thing, the third letter is r. That is all I can share")
                                self.cmdloop()
                                break
                            elif user_input == 'b' or user_input.startswith("Yeah"):
                                print("Prof Dan:Bud.. work with me here, go check the puzzle and come back")
                                self.cmdloop()
                                break
                            elif user_input == 'c' or user_input.startswith('exit'):
                                self.cmdloop()
                                break
                            elif user_input == 'a' or user_input.startswith('What'):
                                print("Prof Dan:Bud.. work with me here, go check the puzzle and come back")
                                break
                            ...
                            print("Prof Dan: I have been studying this Pharoh for years.. he was overthrown, and his enemies burned his records. I want to bring them back")
                            print("Prof Dan: That is where you come in, if you find the treasure it will prove his existance and secure my funding")
                            print('ok response [Reputation: ' + str(like_counter) + ']')
                        ...
                        like_counter = +0
                        rep_professor = rep_professor + like_counter
                        print('ok [Reputation: ' + str(like_counter) + ']')

                        print("Prof Dan:Oh him? hes just a salty jerk who doesnt like to have his masculinity challenged... I have been stuck with him for 20 years")
                        ...
                        user_input = input("> ").strip().lower()
                        if user_input == '1':
                            print('Prof Dan: Us? no, help you? maybe... hes a interesting guy I guess, just let him ramble [Reputation: ' + str(like_counter) + ']')
                            ...
                            print("Prof Dan: I never wanted him to come in the first place so I dont know why he resents me but whatever")
                            break
                    ...
                    print("Prof Dan: Well yes, I wanted to expand my professional career and uh the other guy? he wants money")
                    print("a:Seriously I have to convince him? Can I solve it on my own?")
                    print("b:Well he told me some stuff already, I will just go solve it")
                    print("c: exit")

                    user_input = input("> ").strip().lower()
                    if user_input == 'a':  # Side Response 2-1
                        print('ok response [Reputation: ' + str(like_counter) + ']')

                        print("Prof Dan: Yeah seriously, unless you can figure out the code, which more power to you if you can")
                        print("Prof Dan: Think of a river, its related trust me")
                        
                        self.cmdloop()
                        break
                    elif user_input == 'b':  # Side Response 2-2
                        like_counter = -1
                        rep_professor = rep_professor + like_counter
                        print('bad response [Reputation: ' + str(like_counter) + ']')
                    ...
                    print("Prof Dan: Not sure if I am sane? well what about you?? Youre the idiot who got stuck in here recently ")
                    ...
                    if user_input == '1'or user_input.startswith('What'):  # Side Response 3-1
                        ...
                        self.cmdloop()
                        break
                    elif user_input == '2' or user_input.startswith('exit'):  # Side Response 3-2
                        self.cmdloop()
                        break
